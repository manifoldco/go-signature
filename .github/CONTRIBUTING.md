...
- [Search our issue
  tracker](https://github.com/manifoldco/go-signature/issues/search&type=issues)
  for your problem, someone may have already reported it

# Opening a Pull Request

To contribute, [fork](https://help.github.com/articles/fork-a-repo/)
`go-signature`, commit your changes, and [open a pull
...
Manifold's go-signature is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/go-signature), either for an
